...
const gridItems = [
  {
    ...
    imageSrc: "/devops/github-actions.jpg",
    href: "/blog/devops/github-actions-ci-cd",
  },
  {
    area: "md:[grid-area:1/7/2/13] xl:[grid-area:2/1/3/5]",
    ...
    imageSrc: "/devops/docker.jpg",
    href: "/blog/devops/docker-basics",
  },
  {
    area: "md:[grid-area:2/1/3/7] xl:[grid-area:1/5/3/8]",
    icon: <Settings className="h-4 w-4 text-black dark:text-neutral-400" />,
    ...
    imageSrc: "/devops/kubernetes.jpg",
    href: "/blog/devops/kubernetes-intro",
  },
  {
    area: "md:[grid-area:2/7/3/13] xl:[grid-area:1/8/2/13]",
    ...
    imageSrc: "/devops/terraform.jpg",
    href: "/blog/devops/terraform-iac",
  },
  {
    area: "md:[grid-area:3/1/4/13] xl:[grid-area:2/8/3/13]",
    ...
    imageSrc: "/devops/monitoring.jpg",
    href: "/blog/devops/monitoring-prometheus-grafana",
  },
];

export const metadata = {
  title: "DevOps Blog – Automation, CI/CD, Monitoring | Kumar Web Works",
  description: "Learn DevOps with tutorials on CI/CD, Docker, Kubernetes, Terraform, and observability tools.",
  metadataBase: new URL("https://www.kumarwebworks.com/blog/devops"),
  alternates: {
    canonical: "/blog/devops",
  },
  openGraph: {
    title: "DevOps Blog – Automation, CI/CD, Monitoring | Kumar Web Works",
    description: "Learn DevOps with tutorials on CI/CD, Docker, Kubernetes, Terraform, and observability tools.",
    url: "https://www.kumarwebworks.com/blog/devops",
    siteName: "Kumar Web Works",
    images: [
      {
        url: "https://www.kumarwebworks.com/devops.jpg",
        width: 800,
        height: 600,
        alt: "DevOps Blog - Kumar Web Works",
      },
    ],
  },
  twitter: {
    ...
    title: "DevOps Blog – Automation, CI/CD, Monitoring | Kumar Web Works",
    description: "Learn DevOps with tutorials on CI/CD, Docker, Kubernetes, Terraform, and observability tools.",
    images: ["https://www.kumarwebworks.com/devops.jpg"],
  },
  robots: "index, follow",
  keywords: "devops blog, github actions, docker, kubernetes, terraform, monitoring, cloud automation",
  type: "website",
  locale: "en_US",
};

const DevOpsBlogPage = () => {
  return (
    <>
      <Meta {...metadata} />
